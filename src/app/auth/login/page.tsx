      ...
      <div className="max-w-md w-full space-y-8 bg-[#1E2329] p-8 rounded-xl border border-[#2B3139] shadow-2xl">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-[#929AA5]">
            Or{" "}
            <Link href="/auth/register" className="font-medium text-[#F3BA2F] hover:text-[#FCD535]">
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className="mt-1 appearance-none relative block w-full px-3 py-3 border border-[#474D57] placeholder-[#474D57] text-[#EAECEF] bg-[#181A20] rounded-lg focus:outline-none focus:ring-[#F3BA2F] focus:border-[#F3BA2F] focus:z-10 sm:text-sm"
